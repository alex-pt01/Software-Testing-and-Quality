...
public class SetOfNaturalsTest {
    ...
    public void positiveInteger() {
        assertThrows(IllegalArgumentException.class, () -> setA.add(-1), "Not supported negative integer!!");
    }

    @Test
    public void duplicateInteger() {
        setA.add(70);
        assertThrows(IllegalArgumentException.class, () -> setA.add(69), "duplicate integer");
    }

    @Test
    public void intersectSameSet() {
        assertTrue(setC.intersects(setC), "There is an intersection!");
    }
    @Test
    public void intersectDifferentSets() {
        assertTrue(setA.intersects(setB), "There is an intersection!");
    }
    @Test
    public void containsVerification() {
        assertTrue(setB.contains(50), "Set B contains number 50!");
